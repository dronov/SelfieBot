...
public class FaceTrackingActivity extends Activity {
    ...
    private void startFaceDetection() {
        ...
        if(params.getMaxNumDetectedFaces()>0){
            ...
            Toast.makeText(getApplicationContext(), getString(R.string.no_face_detect),
    ...
    class MyFaceDetectionListener implements Camera.FaceDetectionListener {
        ...
        public MyFaceDetectionListener(SurfaceView sv){
            this.surfaceView = sv;
        }

        private void drawFocusRect(RectF rect, int color) {
            ...
            paint.setTextSize(paint.getTextSize() * 7);
        ...
        public void onFaceDetection(Camera.Face[] faces, Camera camera) {
            ...
            for (int i = 0; i < faces.length; i++) {
                if (faces[0].score > 10) {
                    ...
                    Log.i("FaceDetection", " Face " + i + " Location X: " + rect.centerX()
                            + "Y: " + rect.centerY());
